# Contributing to ETCA

Thanks for your interest in contributing to **ETCA**!
...
## Getting Started
To set up ETCA locally:

1. Fork the repository and clone it:

```bash
git clone https://github.com/epiksabin/ETCA
cd ETCA
```

## Project Structure
- `src/` - Source code for ETCA
- `docs/` - Documentation files and misc
